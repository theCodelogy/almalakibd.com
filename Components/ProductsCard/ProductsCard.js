...
<h1 className='text-xl font-bold my-5'>Products</h1>
          ...
          <div className="flex justify-center w-full h-48 lg:h-[280px] relative">
              ...
              <Image className="rounded-lg bg-black/40 w-full h-full" src={ImageOne} alt="card navigate ui" />
          </div>
      ...
      <div className="px-4 py-2  space-y-6  mx-auto bg-white">
          <div className="flex justify-center w-full h-48 lg:h-[280px] relative">
              ...
              <Image className="rounded-lg bg-black/40 w-full h-full" src={ImageTwo} alt="card navigate ui" />
          </div>
          <div className="text-center w-[85%] mx-auto font-semibold space-y-2">
              <h6 className="text-sm md:text-base lg:text-lg">Waterproof Sport HD Monitor for MacBook</h6>
              <p className="text-gray-400 text-xs md:text-sm font-semibold">Macbook Air</p>
      ...
      <div  className="px-4 py-2  space-y-6  mx-auto bg-white">
          <div className="flex justify-center w-full h-48 lg:h-[280px] relative">
              ...
              <Image className="rounded-lg bg-black/40 w-full h-full" src={ImageThree} alt="card navigate ui" />
          </div>
          <div className="text-center w-[85%] mx-auto font-semibold space-y-2">
              <h6 className="text-sm md:text-base lg:text-lg">Waterproof Sport HD Monitor for MacBook</h6>
              <p className="text-gray-400 text-xs md:text-sm font-semibold">Macbook Air</p>
